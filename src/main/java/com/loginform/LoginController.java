...
public class LoginController implements Initializable {
    ...
    public void accountantButtonPushed(ActionEvent event) throws IOException {
        Parent tableViewParent = FXMLLoader.load(getClass().getResource("../../../resources/accountant-ui.fxml"));
    ...
    public void cashierButtonPushed(ActionEvent event) throws IOException {
        Parent tableViewParent = FXMLLoader.load(getClass().getResource("../../../resources/FXMLArrivalWindow.fxml"));
        Scene tableViewScene = new Scene(tableViewParent);
